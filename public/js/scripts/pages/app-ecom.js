...
$(function () {
  ...
  if (btnCart.length) {
    btnCart.on('click', function (e) {
      ...
      addToCart.text('Agregado al Carrito').removeClass('add-to-cart').addClass('view-in-cart');
      addToCart.addClass('item-in-cart');
      $this.attr('href', checkout);
      toastr['success']('', 'Producto agregado al  🛒', {
        closeButton: false,
        debug: false,
        newestOnTop: false,
        progressBar: false,
