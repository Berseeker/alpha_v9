<div class="owl-carousel owl-theme home-slider">
    ...
    <a href="https://heyzine.com/flip-book/090004d0bd.html" target="_blank" class="item"> <img src="{{ asset('imgs/v3/slider/clases_24.svg') }}" class="w-100" alt="Regreso a Clases"> </a>
