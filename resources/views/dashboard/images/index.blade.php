        ...
        <script type="text/javascript">
            ...
            select.addEventListener('change', function handleChange(event) {
                ...
                if(event.target.value == 'catalogos'){
                    ...
                    $template = '<div class="form-group"><label> Titulo del Catalogo:</label> <input name="titulo" type="test" class="form-control" /></div>' +
                    '<div class="form-group"><label> Descripcion del catalogo:</label> <input type="text" name="parrafo" class="form-control" /> </div>' +
                    '<div class="form-group"><label> Catalogo (PDF):</label> <input type="file" name="pdf" class="form-control"> </div>';
