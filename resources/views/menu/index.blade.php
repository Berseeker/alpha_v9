                                            ...
                                            <div class="col-12 col-sm-3 col-md-2 col-lg-2 col-xl-2" style="margin-bottom:10px;">
                                                ...
                                                <ul class="list-unstyled">
                                                    @foreach ($categoria->subcategorias as $subcategoria)
                                                        <li class="nav-item"><a href="{{ url(Str::slug($subcategoria->categoria->nombre, '-') . '/subcategoria/' . Str::slug($subcategoria->nombre, '-')) }}" class="nav-link custom-a pb-0 hvr-underline-from-center" style="padding: 0.1rem 0.5rem;font-size:10px;">{{ $subcategoria->nombre }}</a></li>
