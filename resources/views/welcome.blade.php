...
@section('content')
    ...
    <div class="owl-carousel owl-theme custom-t">
        ...
        <a href="{{ asset('catalogos/catalogo_2022.pdf') }}" target="_blank" class="item"><img src="{{ asset('imgs/slider/agendas.png') }}" alt="" height="550px;" class="customImgSilder"></a>
        <a href="{{ asset('catalogos/catalogo_2022.pdf') }}" target="_blank" class="item"><img src="{{ asset('imgs/slider/verano.png') }}" alt="" height="550px;" class="customImgSilder"></a>
        <a href="{{ asset('catalogos/catalogo_2022.pdf') }}" target="_blank" class="item"><img src="{{ asset('imgs/slider/golf.png') }}" alt="" height="550px;" class="customImgSilder"></a>
    </div>
